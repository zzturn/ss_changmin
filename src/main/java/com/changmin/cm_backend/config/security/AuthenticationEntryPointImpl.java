...
import com.changmin.cm_backend.config.common.util.servlet.ServletUtils;
...
public class AuthenticationEntryPointImpl implements AuthenticationEntryPoint {
  ...
  public void commence(
    ...
    ServletUtils.writeJSON(
        response,
        Resp.error(
            ErrorCodeConstants.UNAUTHORIZED.getCode(),
            ErrorCodeConstants.UNAUTHORIZED.getMessage()));
  }
}
