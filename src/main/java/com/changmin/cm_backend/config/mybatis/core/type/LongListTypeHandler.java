...
import com.changmin.cm_backend.config.common.util.string.StrUtils;
...
public class LongListTypeHandler implements TypeHandler<List<Long>> {
  ...
  @Override
  public void setParameter(PreparedStatement ps, int i, List<Long> strings, JdbcType jdbcType)
      throws SQLException {
    // 设置占位符
